...
| **n8n** | via n8n-mcp-tools-expert | CRUD workflows, validar nodos | `n8n-mcp-tools-expert` |
...
```
1. Delegar a n8n-mcp-tools-expert para:
...
3. ¿Incluye workflow N8N?
   SI → delegar a n8n-mcp-tools-expert → verificar
   NO → continuar
...
- `Agent` — delegar a n8n-mcp-tools-expert cuando es workflow
