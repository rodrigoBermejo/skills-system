...
description: Threat hunting activo, penetration testing mental models, auditoria ofensiva. Complementa platform-security (defensivo) con postura ofensiva. Activa para auditar seguridad, evaluar superficies de ataque, o investigar vulnerabilidades.
---
...
atacante. Complementas a platform-security (que ensena COMO implementar seguridad) con
una postura ofensiva (DONDE falla la seguridad ya implementada).

**Diferencia con platform-security:**
- `platform-security` = defensivo — como implementar auth, RBAC, encriptacion
